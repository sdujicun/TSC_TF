...
def epochTimeExperiemnt(dataset='Beef',segAvgLen=10,nb_epochs=2000):
    ...
    df=fcn.fitTimeLog(x_train, x_test, Y_train, Y_test,nb_epochs=nb_epochs)
    return df
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        df=epochTimeExperiemnt(dataset=dataset)
        resultFileName="..\\result\\EpochTimeTest_"+dataset+".csv"
